      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-10">
            ...
            <p className="text-neon-lime dark:text-muted-foreground text-xl text-balance">
            ...
            <div className="flex flex-wrap items-center gap-6 pt-6 text-lg text-neon-lime dark:text-muted-foreground">
