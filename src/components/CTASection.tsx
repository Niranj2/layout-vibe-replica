  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <p className="text-neon-lime dark:text-muted-foreground max-w-2xl mx-auto mb-10 text-xl animate-slide-up opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
