...
const Stories: React.FC = () => {
  return (
    <section id="stories" className="py-28 px-6 lg:px-12 bg-[#003E2B] text-white relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="mb-12">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Marketing Frog Success Stories</h2>
        </div>
